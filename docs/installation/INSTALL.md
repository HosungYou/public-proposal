...
Verified compatibility date: **2026-08-28**. The exact supported versions are `@longtable/public-proposal@0.2.3`, `@longtable/kpp-cli@0.3.0`, `@longtable/cli@0.1.72`, and managed worker protocol `1.0.0`. See [compatibility-matrix.json](compatibility-matrix.json) for the machine-readable contract.
...
The package is published on npm as `@longtable/public-proposal@0.2.3`. Leaving off the version below resolves the current `latest` tag; pin `@0.2.3` when reproducibility is required.
...
```bash
npm install --global @longtable/public-proposal@0.2.3 @longtable/kpp-cli@0.3.0 @longtable/cli@0.1.72
