...
This package is published on npm as `@longtable/public-proposal@0.1.2`. The commands below are the supported interface; pin `@0.1.2` when reproducibility is required.
...
| --- | --- | --- |
| `@longtable/public-proposal` | `0.1.2` | Installer and installation receipt |
